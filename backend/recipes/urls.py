...
urlpatterns = [
    ...
    path('bulk/', views.RecipeBulkCreate.as_view(), name="recipe-bulk-create"),
    # Specific recipes
    path('<int:pk>/', views.SingleRecipeListRetrieveUpdateDestroy.as_view(), name="recipe-view-retrieve-update-destroy"),
