...
const LandingPage = () => {
  return (
    <>
      <main className="flex flex-col p-6 md:p-8 lg:px-10 min-h-[calc(100svh-6rem)] max-w-screen">
        <div
          id="hero-section"
        ...
        >
          ...
          <motion.div
            className="mt-6 lg:mt-0 lg:w-3/5"
      ...
      <footer className="flex justify-center h-12">
        ...
        >
          © {new Date().getFullYear()} Built by Viet. For Viet :D
        </motion.div>
      </footer>
    </>
  );
